...
function DetailOne ( props ) {
    ...
    useEffect( () => {
        ...
        return () => {
            ...
            if ( document.querySelector( '.quickview-modal .reset-value-button' ) ) {
    ...
    useEffect( () => {
        if ( product.data.variants.length > 0 ) {
            ...
            if ( curSize !== 'null' || curColor !== 'null' ) {
                if ( document.querySelector( '.quickview-modal .reset-value-button' ) && document.querySelector( '.quickview-modal .reset-value-button' ).classList.contains( 'COLLAPSED' ) ) {
                    document.querySelector( '.quickview-modal .show-reset-button' ).click();
                }
            } else if ( document.querySelector( '.quickview-modal .reset-value-button' ) && document.querySelector( '.quickview-modal .reset-value-button' ).classList.contains( 'EXPANDED' ) ) {
                document.querySelector( '.quickview-modal .show-reset-button' ).click();
            }
        } else {
            document.querySelector( '.quickview-modal .products-form .btn-cart' ).removeAttribute( 'disabled' );
    ...
    const resetValueHandler = ( e ) => {
        ...
        if ( document.querySelector( '.quickview-modal .select-color' ) ) {
            document.querySelector( '.quickview-modal .select-color' ).value = 'null';
        }
        if ( document.querySelector( '.quickview-modal .select-size' ) ) {
            document.querySelector( '.quickview-modal .select-size' ).value = 'null';
        }
    }
